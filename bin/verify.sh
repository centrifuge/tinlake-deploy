...
dapp verify-contract --async 'src/lender/token/restricted.sol:RestrictedToken' $JUNIOR_TOKEN '"KR2TIN"' '"KR2 TIN Token"'
...
dapp verify-contract --async 'src/lender/token/restricted.sol:RestrictedToken' $SENIOR_TOKEN '"KR2DRP"' '"KR2 DROP Token"'
