...
[[ -z "$JUNIOR_TOKEN_NAME" ]] && JUNIOR_TOKEN_NAME="Bling Series 1 TIN"
[[ -z "$JUNIOR_TOKEN_SYMBOL" ]] && JUNIOR_TOKEN_SYMBOL="BL1TIN"
[[ -z "$SENIOR_TOKEN_NAME" ]] && SENIOR_TOKEN_NAME="Bling Series 1 DROP"
[[ -z "$SENIOR_TOKEN_SYMBOL" ]] && SENIOR_TOKEN_SYMBOL="BL1DRP"
...
seth send $LENDER_DEPLOYER 'init(uint,uint,uint,uint,uint,string memory,string memory,string memory,string memory)' $MIN_SENIOR_RATIO $MAX_SENIOR_RATIO $MAX_RESERVE $CHALLENGE_TIME $SENIOR_INTEREST_RATE '"Bling Series 1 DROP"' '"BL1DRP"' '"Bling Series 1 TIN"' '"BL1TIN"'
...
# dapp verify-contract --async 'src/lender/token/restricted.sol:RestrictedToken' $JUNIOR_TOKEN '"BL1TIN"' '"Bling Series 1 TIN"'
...
# dapp verify-contract --async 'src/lender/token/restricted.sol:RestrictedToken' $SENIOR_TOKEN '"BL1DRP"' '"Bling Series 1 DROP"'
